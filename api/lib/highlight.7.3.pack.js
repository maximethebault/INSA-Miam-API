var hljs = new function() {
    ...
    function c(q) {
        ...
        (function p(r, s) {
            for(var t = r.firstChild; t; t = t.nextSibling) {
                if(t.nodeType == 3) {s += t.nodeValue.length}
                else {
                    if(t.nodeName == "BR") {s += 1}
                    else {
                        if(t.nodeType == 1) {
    ...
    function j(x, v, w) {
        ...
        function t() {
            if(x.length && v.length) {
                if(x[0].offset != v[0].offset) {return(x[0].offset < v[0].offset) ? x : v}
                else {return v[0].event == "start" ? x : v}
            }
    ...
    function f(q) {
        ...
        function p(y, w) {
            ...
            if(y.k) {
                ...
                if(typeof y.k == "string") {z("keyword", y.k)}
                else {
                    for(var x in y.k) {
    ...
    function d(D, E) {
        ...
        try {
            ...
            if(H == "Illegal") {return{r: 0, keyword_count: 0, value: l(E)}}
            else {throw H}
        }
    }
    ...
    function m(r, u, p) {
        ...
        if(w.second_best) {r.second_best = {language: w.second_best.language, kw: w.second_best.keyword_count, re: w.second_best.r}}
    }
