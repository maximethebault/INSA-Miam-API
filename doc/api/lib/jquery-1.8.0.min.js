...
(function(a, b) {
    ...
    p.fn = p.prototype = {constructor: p, init: function(a, c, d) {
        ...
        if(d) {
            if(h) {for(e in a)if(c.apply(a[e], d) === !1)break}
            else {
                for(; f < g;)if(c.apply(a[f++], d) === !1)break
            }
        }
    ...
    p.event = {add: function(a, c, d, e, f) {
        ...
        h.querySelectorAll && function() {
            ...
            T(function(a) {
                ...
                if(!g && !h && (!e || !e.test(a))) {
                    if(d.nodeType === 9) {
                        try {return o.apply(f, n.call(d.querySelectorAll(a), 0)), f}
                        catch(i) {}
                    }
                        ...
                        finally {j || d.removeAttribute("id")}
                    }
                }
                return b(a, d, f, g, h)
            }, g && (T(function(b) {
